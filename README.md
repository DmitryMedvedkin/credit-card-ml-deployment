...
Production-like-среда сервис машинного обучения для прогнозирования дефолта по кредитным картам. Проект охватывает полный цикл: обучение и сохранение моделей -> Flask API -> контейнеризация (Docker) -> A/B-тестирование
